      ...
      <InspectP>
        <Styledmain>
          <Form>
            ...
            <Input value={projectName} type="text" onChange={handleChange} />
            <Input value={projectDesc} type="text" placeholder = "Project Description"onChange={handleChange} placeholder = "Project Name" />
