...
//   const inputEl = useRef(null)
  ...
  const [projectDesc, setProjectDesc] = useState(data.description);
//   console.log(data);
      ...
      <InspectP>
        <Styledmain>
          <Form>
            ...
            <Input value={projectName} type="text" onChange={handleChange} placeholder= "Project Name" />
            <Input value={projectDesc} type="text" placeholder = "Project Description"onChange={handleChange}  />
